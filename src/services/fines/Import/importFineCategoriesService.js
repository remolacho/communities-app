...
export function importFineCategoriesService(file) {
    const url = `${API_HOST}/${getSubdomainApi()}/v1/fines/categories/import?lang=${getLang()}`;
...
function params(file) {
    ...
    formData.append('fines_categories_file', file);

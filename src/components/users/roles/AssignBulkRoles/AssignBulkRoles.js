...
import {assignFileUserRolesService} from "../../../../services/usersRoles/Import/assignFileUserRolesService";

import "./AssignBulkRoles.scss"

export default function AssignBulkRoles() {
    ...
    const uploadFile = () =>{
        ...
        assignFileUserRolesService(xlsxFile).then(response => {
            if (!response.success) {
    ...
    return(
        <div className="d-flex justify-content-center align-items-center assign-bulk-roles">
            <Card>
                <Card.Body>
                    <Card.Title>Asignación de roles</Card.Title>
                    <Card.Text>
                        Puedes cargar de forma masiva roles a los usuarios, descarga la plantilla en el enlace, luego agrega
                        la cedula en la columna identifier y marca con una x la columna del role o roles que deseas asignar.
                    </Card.Text>
                    <div
